...
class ClosedLoopPathFollower(Node):
    def __init__(self):
        ...
        ####    CODE HERE
        # Add Parameters for Closed-loop controller parameters: Vmax, Beta, gamma, and angle_focus_factor
        # Give them default values, respectively: 0.2, 2.0, 3.0, 0.0
        self.Vmax = self.declare_parameter('/Vmax',0.2).value 
        self.Beta = self.declare_parameter ...
        self.gamma = ... 
        self.angle_focus_factor = ...
        ####    END CODE
